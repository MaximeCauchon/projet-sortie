...
//            ->from(new Address('contact@sortir.com', 'Equipe de Sortir.com'))
//            ->to($user->getEmail())
...
//    }
	...
	private function processSendingPasswordResetEmail(string $emailFormData, TranslatorInterface $translator): RedirectResponse|Response
	{
		$user = $this->entityManager->getRepository(Participant::class)->findOneBy([
			'email' => $emailFormData,
		]);
